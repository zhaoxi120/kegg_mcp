...
SERVER_INSTRUCTIONS = (
    ...
    "local enrichment, KEGG Mapper, or KEGG Syntax input bundles. It does not retrieve or "
    "interpret papers, run enrichment statistics, upload files, execute external KEGG tools, or "
    "parse their results. For analysis it accepts existing K numbers or supported KO "
