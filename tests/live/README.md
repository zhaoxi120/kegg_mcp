...
The campaign covers KO `INFO`, BRITE `GET`, KO-to-pathway `LINK`, and selected gene-to-UniProt
`CONV` cases; injected-transport tests cover broader parameter boundaries.
...
The campaign and BRITE compact htext shape use the official KEGG API behavior reviewed on
2026-07-16. Repeat the campaign against the exact merged release commit. The governing primary
sources were retrieved on 2026-07-16:
