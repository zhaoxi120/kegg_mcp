...
@pytest.mark.parametrize(
    ...
    [
        ...
        (KeggFindDatabase.GLYCAN, "G00001"),
        (KeggFindDatabase.DRUG, "D00109"),
        (KeggFindDatabase.RCLASS, "RC00002"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (KeggFindDatabase.GLYCAN, "gl:G00001"),
        (KeggFindDatabase.DRUG, "dr:D00109"),
        (KeggFindDatabase.RCLASS, "rc:RC00002"),
